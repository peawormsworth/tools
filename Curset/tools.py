...
def nan_str (x):
    # there is a better way...from fractions import Fraction
from curset import *
...
# nan bracketed string representation
def nan_str (x):
    """alternate output for Curset using brackets and nulls"""
...
def create (days=7):
    """
    return a dict of all Cursets generated up to the given day.
    """
    birth    = canal()
    sprout   = cleave()
    universe = {}
